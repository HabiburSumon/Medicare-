...
class _ECommerceHomeTab extends StatefulWidget {
  const _ECommerceHomeTab();
  @override
  State<_ECommerceHomeTab> createState() => _ECommerceHomeTabState();
}
...
class _ECommerceHomeTabState extends State<_ECommerceHomeTab> {
  ...
  Future<void> _loadData() async {
    try {
      ...
      setState(() {
        _medicines = (responses[0]['data'] as List)
            .map((e) => Medicine.fromJson(e))
            .toList();
        _doctors = (responses[1]['data'] as List)
              ...
              slivers: [
                ...
                SliverAppBar(
                  ...
                  title: Column(
                    ...
                    children: [
                      Text(
                        'Hello, ${auth.user?.name.split(' ').first ?? 'User'} \u{1F44B}',
                ...
                SliverToBoxAdapter(
                  child: Padding(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        const Text('Popular Medicines & Products',
                            style: TextStyle(
                                fontSize: 18, fontWeight: FontWeight.bold)),
                        TextButton(
                          onPressed: () => Navigator.push(
                ...
                SliverPadding(
                  ...
                  sliver: SliverGrid(
                    ...
                    delegate: SliverChildBuilderDelegate(
                      ...
                      childCount:
                          _medicines.length > 6 ? 6 : _medicines.length,
                    ),
                  ),
                ),
                ...
                SliverToBoxAdapter(
                  child: SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      padding: const EdgeInsets.symmetric(horizontal: 16),
                      itemCount:
                          _doctors.length > 8 ? 8 : _doctors.length,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(children: [
                          Expanded(
                              child: _healthProductCard(
                                  'Medical Devices',
                                  'Thermometers, BP monitors & more',
                                  Icons.devices,
                                  const Color(0xFF2563EB))),
                                ...
                                children: [
                                  Text('Flash Sale!',
                                      style: TextStyle(
                                          ...
                                          fontWeight: FontWeight.bold)),
                                  SizedBox(height: 4),
                                  Text('Up to 50% off on health products',
                                      style: TextStyle(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        _tipCard('Regular Exercise',
                            '30 minutes of daily activity keeps you fit',
                            const Color(0xFF10B981)),
                        const SizedBox(height: 8),
                        _tipCard('Balanced Diet',
...
class _DoctorHomeTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Dr. ${auth.user?.name.split(' ').first ?? 'Doctor'}'),
      ),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(children: [
              Expanded(
                child: _statCard(
                    'Today\'s\nAppointments', '0', Icons.calendar_today, const Color(0xFF2563EB)),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: _statCard(
                    'Total\nPatients', '0', Icons.people, const Color(0xFF10B981)),
              ),
            ]),
            const SizedBox(height: 12),
            Row(children: [
              Expanded(
                child: _statCard(
                    'Pending\nReviews', '0', Icons.rate_review, const Color(0xFFF59E0B)),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: _statCard(
                    'Earnings\nThis Month', '\u09F30', Icons.account_balance_wallet, const Color(0xFF8B5CF6)),
              ),
            ]),
            const SizedBox(height: 24),
            ...
            Row(children: [
              ...
              Expanded(
                child: _actionCard(
                    'Messages', Icons.chat, const Color(0xFF10B981), () {}),
              ),
            ]),
            const SizedBox(height: 12),
            Row(children: [
              Expanded(
                child: _actionCard(
                    'My Profile', Icons.person, const Color(0xFFF59E0B), () {}),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: _actionCard(
                    'Settings', Icons.settings, const Color(0xFF8B5CF6), () {}),
              ),
            ]),
            const SizedBox(height: 24),
