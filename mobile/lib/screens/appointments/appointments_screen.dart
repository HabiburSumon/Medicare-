...
class _AppointmentsScreenState extends State<AppointmentsScreen> {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(appBar: AppBar(title: const Text('Appointments')), body: _loading ? const AppLoading() : _appointments.isEmpty ? const Center(child: Text('No appointments yet')) : RefreshIndicator(onRefresh: _load,
